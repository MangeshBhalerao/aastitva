...
function Animesweatshirt() {
  const { addToCart } = useContext(CartContext)

  const animeProducts = Sweatshirtproducts.filter(product => product.design === 'Anime')
  ...
  return (
    <div className='w-full min-h-screen bg-[#500303] text-white p-4' style={{
      ...
      <h1 className='text-5xl text-center text-white font-thin mb-8'>Anime Sweatshirts</h1>
...
export default Animesweatshirt