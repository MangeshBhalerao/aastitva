...
function Sweatshirt() {
  return (
    <div className='bg-[#500303] text-white' style={{ 
      backgroundImage: 'url(https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExM2tmZng3MXF2MzloN3RiZmk5dHpydGc1ODJhY3pxM283cm94cmlyZCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/8373y6DJzdPFk2snLw/giphy.webp)',
      ...
      <div className='bg-cover bg-center h-[10vh] flex items-center justify-center'>
        <h1 className='text-5xl font-bold text-black'>SWEATSHIRT</h1>
      </div>
